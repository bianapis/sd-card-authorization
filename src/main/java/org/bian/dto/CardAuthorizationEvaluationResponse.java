...
/**
 * CardAuthorizationEvaluationResponse
 */
public class CardAuthorizationEvaluationResponse   {
  ...
  private String cardAuthorizationEvaluationResult = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text 
   * @return cardAuthorizationEvaluationResult
  **/

  public String getCardAuthorizationEvaluationResult() {
    return cardAuthorizationEvaluationResult;
  }

  public void setCardAuthorizationEvaluationResult(String cardAuthorizationEvaluationResult) {
    this.cardAuthorizationEvaluationResult = cardAuthorizationEvaluationResult;
  }
